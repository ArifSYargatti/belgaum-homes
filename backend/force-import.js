...
const propertySchema = new mongoose.Schema({
  ...
  location: String, advantages: [String], amenities: [String],
  images: [String], premium: Boolean, featured: Boolean,
  isNewLaunch: Boolean, isExclusive: Boolean, status: String,
  views: Number, inquiries: Number, createdAt: Date
});

const Property = mongoose.model('Property', propertySchema);

// ALL 22 PROPERTIES with CLEAR titles (no duplicates)
const properties = [
  // 1
  {
    title: "Luxury 3BHK in Shahapur - Premium Living",
  ...
  // 2
  {
    title: "2BHK Premium Apartment in Shahapur",
    price: "₹65,00,000", priceValue: 6500000,
    size: "1200 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Shahapur", location: "Near Maruti Galli",
  ...
  // 3
  {
    title: "Shahapur Luxury Villa with Private Pool",
    price: "₹1,50,00,000", priceValue: 15000000,
    size: "2500 sq ft", bedrooms: 4, bathrooms: 4,
    area: "Shahapur", location: "Near Club Road",
  ...
  // 5
  {
    ...
    size: "2000 sq ft", bedrooms: 3, bathrooms: 3,
    area: "Tilakwadi", location: "Near Ramdev Galli",
  ...
  // 7
  {
    title: "3BHK Army Quarters Style in Camp Area",
    price: "₹75,00,000", priceValue: 7500000,
    size: "1400 sq ft", bedrooms: 3, bathrooms: 2,
    area: "Camp", location: "Near Clock Tower",
  ...
  // 8
  {
    title: "Premium 4BHK at RPD Cross - City Views",
  ...
  // 9
  {
    ...
    price: "₹48,00,000", priceValue: 4800000,
    size: "950 sq ft", bedrooms: 2, bathrooms: 2,
    area: "RPD Cross", location: "Near Hanuman Nagar",
  ...
  // 11
  {
    ...
    price: "₹52,00,000", priceValue: 5200000,
    size: "1050 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Gogte Chowk", location: "Near KLE University",
  ...
  // 12
  {
    ...
    price: "₹78,00,000", priceValue: 7800000,
    size: "1450 sq ft", bedrooms: 3, bathrooms: 2,
    area: "Vadagaon", location: "Near Vishwanath Nagar",
    ...
    premium: true, featured: true, isNewLaunch: true, isExclusive: false
  },
  // 13
  {
    title: "2BHK Vadagaon Near Bus Stand - Convenient",
    price: "₹48,00,000", priceValue: 4800000,
    size: "980 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Vadagaon", location: "Near Vadagaon Bus Stand",
  ...
  // 14
  {
    ...
    price: "₹92,00,000", priceValue: 9200000,
    size: "1600 sq ft", bedrooms: 3, bathrooms: 3,
    area: "Machhe", location: "Near Machhe Industrial Area",
  ...
  // 15
  {
    title: "1BHK for Bachelors in Machhe - Budget",
    price: "₹32,00,000", priceValue: 3200000,
    size: "680 sq ft", bedrooms: 1, bathrooms: 1,
    area: "Machhe", location: "Near Machhe Circle",
  ...
  // 16
  {
    ...
    price: "₹88,00,000", priceValue: 8800000,
    size: "1550 sq ft", bedrooms: 3, bathrooms: 2,
    area: "Sambhaji Nagar", location: "Near Sambhaji Garden",
    ...
    premium: true, featured: false, isNewLaunch: false, isExclusive: false
  },
  // 17
  {
    title: "2BHK Family Home in Sambhaji Nagar",
    price: "₹58,00,000", priceValue: 5800000,
    size: "1080 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Sambhaji Nagar", location: "Near Market Yard",
  ...
  // 18
  {
    ...
    price: "₹52,00,000", priceValue: 5200000,
    size: "1000 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Hindustan Petroleum", location: "Near HP Petrol Bunk",
  ...
  // 19
  {
    ...
    price: "₹95,00,000", priceValue: 9500000,
    size: "1700 sq ft", bedrooms: 3, bathrooms: 3,
    area: "Udyambag", location: "Near Udyambag Police Station",
  ...
  // 20
  {
    ...
    price: "₹30,00,000", priceValue: 3000000,
    size: "650 sq ft", bedrooms: 1, bathrooms: 1,
    area: "Udyambag", location: "Near Udyambag Temple",
  ...
  // 21
  {
    ...
    size: "920 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Hanuman Nagar", location: "Near Hanuman Temple",
  ...
  // 22 - The missing one! Different from #11
  {
    title: "2BHK Near KLE University - Belgaum Main",
    price: "₹52,00,000", priceValue: 5200000,
    size: "1050 sq ft", bedrooms: 2, bathrooms: 2,
    area: "Gogte Chowk", location: "Near KLE University Main Campus",
    description: "Spacious 2BHK apartment near KLE University. Perfect for faculty and students.",
    advantages: ["Walking distance to university", "Peaceful area", "Good rental income", "Parking available"],
    amenities: ["Parking", "Security", "Study Room", "WiFi Ready", "24x7 Water Supply"],
    images: ["https://placehold.co/600x400/607d8b/white?text=2BHK+KLE+Main"],
    premium: false, featured: false, isNewLaunch: true, isExclusive: false
  }
];
...
async function importProperties() {
  try {
    ...
    // Import ONE BY ONE to catch errors
    let imported = 0;
    let failed = 0;
    ...
    for (let i = 0; i < properties.length; i++) {
      try {
        ...
        await prop.save();
        imported++;
        console.log(`✅ ${imported}. ${properties[i].title}`);
      } catch (err) {
        failed++;
        console.log(`❌ Failed: ${properties[i].title} - ${err.message}`);
      }
    }
